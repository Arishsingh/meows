...
export default function Page() {
  return (
    <main className="mx-auto max-w-3xl px-6 py-16 md:py-24">
      ...
      <p className="mt-4 text-lg leading-relaxed text-muted-foreground">Your privacy matters. This explains what Taskline collects and how it is used.</p>
      <div className="mt-12 space-y-10">
        <section className="space-y-3">
          <h2 className="font-display text-xl font-semibold tracking-tight text-foreground">1. Overview</h2>
          <p className="leading-relaxed text-muted-foreground">This policy describes how Taskline collects, uses, and protects your information when you use the service.</p>
        </section>
        <section className="space-y-3">
