...
export const metadata: Metadata = {
  ...
  description: "A portfolio that turns first impressions into an experiment.",
  applicationName: "Lumen",
  keywords: ["lumen","refined","airy","confident","curated","Lumen"],
  ...
  return (
    <html lang="en" className={fonts.className} style={roleVars}>
      <body className="font-body">
        <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: "{\"@context\":\"https://schema.org\",\"@type\":\"WebSite\",\"name\":\"Lumen\",\"description\":\"A portfolio that turns first impressions into an experiment.\"}" }} />
