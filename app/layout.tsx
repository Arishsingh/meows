...
export const metadata: Metadata = {
  ...
  title: { default: "Taskline", template: "%s · Taskline" },
  description: "Capture work fast, stay organized, finish cleanly.",
  applicationName: "Taskline",
  keywords: ["taskline","crisp","focused","efficient","modern","Taskline"],
  ...
  return (
    <html lang="en" className={fonts.className} style={roleVars}>
      <body className="font-body">
        <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: "{\"@context\":\"https://schema.org\",\"@type\":\"SoftwareApplication\",\"name\":\"Taskline\",\"description\":\"Capture work fast, stay organized, finish cleanly.\",\"applicationCategory\":\"WebApplication\",\"operatingSystem\":\"Web\"}" }} />
