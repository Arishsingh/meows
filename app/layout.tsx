...
export const metadata: Metadata = {
  metadataBase: new URL(process.env.NEXT_PUBLIC_SITE_URL || "http://localhost:6191"),
  title: { default: "Rankly", template: "%s · Rankly" },
  description: "Find and fix the SEO gaps that keep your deployed app from ranking.",
  applicationName: "Rankly",
  keywords: ["rankly", "seo audit", "metadata", "canonical", "sitemap"],
  openGraph: {
    type: "website",
    siteName: "Rankly",
    title: "Rankly",
  ...
  return (
    <html lang="en" className={fonts.className} style={roleVars}>
      <body className="font-body">
        <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: "{\"@context\":\"https://schema.org\",\"@type\":\"SoftwareApplication\",\"name\":\"Rankly\",\"description\":\"Find and fix the SEO gaps that keep your deployed app from ranking.\",\"applicationCategory\":\"WebApplication\",\"operatingSystem\":\"Web\"}" }} />
