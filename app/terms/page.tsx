...
export default function Page() {
  return (
    <main className="mx-auto max-w-3xl px-6 py-16 md:py-24">
      ...
      <p className="mt-4 text-lg leading-relaxed text-muted-foreground">By using Rankly you agree to these terms. Please read them carefully.</p>
      <div className="mt-12 space-y-10">
        <section className="space-y-3">
          <h2 className="font-display text-xl font-semibold tracking-tight text-foreground">1. Acceptance of terms</h2>
          <p className="leading-relaxed text-muted-foreground">By creating an account or using Rankly, you agree to be bound by these Terms of Service. If you do not agree, do not use the service.</p>
        </section>
        <section className="space-y-3">
        ...
        <section className="space-y-3">
          ...
          <p className="leading-relaxed text-muted-foreground">Rankly is provided “as is” without warranties of any kind, express or implied, including fitness for a particular purpose.</p>
        </section>
        <section className="space-y-3">
